        ...
        <ul class="icon_lists ">
          <li class="dib">
            <svg class="icon svg-icon">
              <use xlink:href="#icon-guanzhu_follow-01"></use>
            </svg>
            <div class="name">关注_follow-01</div>
            <div class="code-name">#icon-guanzhu_follow-01</div>
          </li>
          ...
          <li class="dib">
            <svg class="svg-icon" >
              <use xlink:href="#icon-jianxiaoyinliang"></use>
            </svg>
            <div class="name">减小音量</div>
            <div class="code-name">#icon-jianxiaoyinliang</div>
          </li>
